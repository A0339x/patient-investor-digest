...
- **The Chart variable has two halves: long-horizon health AND where on the chart you're buying.** The Variables Reference frames both: *"we just want to make sure we're not buying at the very top or we're not buying into a chart that has only gone down throughout its lifetime."* Earlier rewrites narrowed The Chart to just the long-horizon half. From Gregory's 2026-05-12 markup on 05-04 Story 1: *"$80k is pretty far from the previous all time high. That's part of the chart variable -- being conscious of where in the chart you buy."*
  ...
  **The two halves:**
  1. **Long-horizon health** — over years, does the asset's chart show two-way action, real highs and lows, the shape of something alive? Or has it only gone in one direction for years? Arbitrum (ARB) trending down for ~3 years is the canonical example of a failing long-horizon chart.
  2. **Where on that chart you're buying** — even on a healthy multi-year chart, where price is sitting today matters. Buying at the very top means most of the downside is in front of you; the upside is in the rearview mirror. Buying well below the previous all-time high means there's still room for upside.
